...
var SharedWorkerSocketIO = function () {
    function SharedWorkerSocketIO(socketUri) {
        _classCallCheck(this, SharedWorkerSocketIO);

        console.log('SharedWorkerSocketIO ', socketUri);
        uri = socketUri;
    }

    _createClass(SharedWorkerSocketIO, [{
        key: 'emit',
...
/***/ })
/******/ ]);
//# sourceMappingURL=socket.io-worker.bundle.js.map